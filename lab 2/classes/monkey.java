...
/**
 * This class is one of the two newly added players and will be the "random" player.
 */
public class monkey extends DiceHand {
    ...
    /**
     * This method will randomly hold and roll dices to act as an irrational player in the game.
     */
