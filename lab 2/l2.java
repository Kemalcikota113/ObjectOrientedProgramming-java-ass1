...
import classes.Dice;
import classes.DiceGraphic;
import classes.DiceGraphicCheating;
...
public class l2{
    public static void main(String[] args){
        ...
        DiceGraphicCheating dgc = new DiceGraphicCheating();

        // System.out.println("⚀, ⚁, ⚂, ⚃, ⚄, ⚅");   ---> this will be used for later
        ...
        while(true){
            ...
            switch(option){
                ...
                case "2":
                    dieGraphic.roll();
                    System.out.println("The rolled die is : " + dieGraphic);
                    break;
